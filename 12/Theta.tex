...
\begin{frame}{$O$-Notation}
    \begin{itemize}[<+->]
    	...
    	\item Beachtet den \emph{Trick} mit den Limites\only<3->{\footnote{Ich weiß nicht, ob ihr den als Beweis in der Klausur oder auf dem Blättern verwenden dürft. Zur Kontrolle sollte man ihn aber kennen.}}
    \end{itemize}
\end{frame}
