...
\begin{frame}{Wdh.: Relationen und Abbildungen}
	\begin{exampleblock}{Beispiel \#2}
		...
		\begin{minipage}{0.45\textwidth}
			...
			Bijektiv Abbildung: & \only<6->{\textcolor{kit-red100}{Nein}} \\
...
\begin{frame}{}
% Tautologie beweisen kennt drei Möglichkeiten:
% 1. Modus Ponens
% 2. Fallunterscheidungen (im Grunde Wahrheitstabelle)
% 3. Abbildung
% Im Fall 2. und 3. sollte zumindest formell korrekt abgebildet werden, so lange es geht, und dannach (!) erst gedacht werden, damit die Tutanten mit dem Formalismen-Wahn aus GBI warm werden. Klar machen, dass das wichtig ist, und erst bis zum bitteren Ende durchgeführt werden sollte.
