...
\begin{itemize}
	\item Wie ausführlich muss man bei den Abbildungen \textbf{Repr}, \textbf{Num} und \textbf{Zkpl} vorgehen?
	\item[]
	\item In meinem Tutorium/auf den ÜBs: Einmal ausführlich, damit ich sehe, ihr habt die Abbildung verstanden
	\item In der Klausur: Fragt im \emph{ILIAS-Forum}, denn das interessiert alle!
\end{itemize}
\end{frame}
