...
\fi
\ifdefined \KilianMode
\input{../config_Kilian.tex} % Kilian Mode
\fi
\ifdefined \JanMode
\input{../config_Jan.tex} % Jan Mode
\fi
\ifdefined \LeonardMode
\input{../config_Leonard.tex} % Leonard Mode
\fi
\ifdefined \MoritzTwoMode
\input{../config_Moritz2.tex} % Moritz Two Mode
\fi
...
\usepackage{tikz}
\usetikzlibrary{arrows,automata,positioning,math}
